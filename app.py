...
with st.sidebar:
    ...
    st.markdown(
        ...
        "<a href=\"https://www.adityapawar.in\" target=\"_blank\" style=\"color:#aaa;font-size:0.62rem;font-weight:600;text-decoration:none;\">🌐 Portfolio</a>"
        "</p>"
        "<p style=\"margin:0 0 8px 0;\">"
        "<a href=\"https://www.adityapawar.in\" target=\"_blank\" style=\"color:#555;font-size:0.58rem;text-decoration:none;word-break:break-all;\">adityapawar.in</a>"
        "</p>"
        "<p style=\"margin:0 0 2px 0;\">"
        "<a href=\"https://www.linkedin.com/in/dev-aditya-pawar\" target=\"_blank\" style=\"color:#aaa;font-size:0.62rem;font-weight:600;text-decoration:none;\">🔗 LinkedIn</a>"
        "</p>"
        "<p style=\"margin:0 0 8px 0;\">"
        "<a href=\"https://www.linkedin.com/in/dev-aditya-pawar\" target=\"_blank\" style=\"color:#555;font-size:0.58rem;text-decoration:none;word-break:break-all;\">linkedin.com/in/dev-aditya-pawar</a>"
        "</p>"
        "<p style=\"margin:0 0 2px 0;\">"
